local att = {}
att.name = "md_scope_l96"
att.displayName = "L96 Scope"
att.displayNameShort = "L96"
att.isSight = true
att.aimPos = {"L96Pos", "L96Ang"}
att.withoutRail = true
att.SpeedDec = 2
att.statModifiers = {OverallMouseSensMult = -0.1}

if CLIENT then
	att.displayIcon = surface.GetTextureID("atts/md_scope_l96")
	att.description = {[1] = {t = "Provides 1.5-4x magnification.", c = CustomizableWeaponry.textColors.POSITIVE},
